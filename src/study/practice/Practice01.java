...
//		전화번호는 OOO-OOOO-OOO 입니다.
		String num = "010-9489-8365";
		System.out.println("전화번호는 " + num + " 입니다.");
//
//
...
//		a. $ystem
//		b. channel#112 :: #포함 안 됨
//		c. 7eleven :: 숫자로 시작할 수 없다
//		d. newmember :: 사용할 수 있으나 다른 단어 붙을 경우 대문자 작성
//		e. $MAX_NUM
//		f. hello@com :: '$' 나 '_' 외의 특수문자
//		g. int :: 예약어 사용불가
		
		/* a,d,e:: 변수 첫글자는 문자이거나 '$', '_'이어야 한다. */
