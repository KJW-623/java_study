...
public class Practice25 {
	...
	public static void level1() {
		...
		System.out.print("엘레베이터가 멈출 수 있는 최대 횟수: ");
		...
		while(true) {
			...
			if(stopCount == maxStopCount) { //멈춘 횟수 다 씀
				System.out.println("[점검 중] 전기 공급의 한계로 엘레베이터가 더 작동하지 않습니다. 남은 분들은 계단으로 가시길 바랍니다.");
				break;
			}
	...
	public static void level2() {
		...
		System.out.print("엘레베이터 탑승 정원 입력: ");
