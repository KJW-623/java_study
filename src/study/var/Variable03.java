...
public class Variable03 {
	...
	public static void main(String[] args) {
		...
		double d3 = i1; // double <- int 자동타입변환 큰타입 = 작은 타입
		
		int i3 = (int)d2; //작은 타입 = (작은타입)큰 타입 	강제타입변환
		
		System.out.println(d2); //3.14
		System.out.println(i3); //3		강제타입변환시 소수점 0.14 손실
		
		//java 정수 -> int 타입 인식
		//jave 실수 -> double 타입 인식
		...
		// 연산을 double과 int 의 연산으로 바꾼다
		// int 값 한 개 or 두 개 모두를 (double) 실수형으로 강제타입변환
