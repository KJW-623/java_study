...
public class Exp01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * //1회성 입력 기회를 주는 예외처리 try { //int input = scanner.nextInt(); //try 지역변수 input
		 * 외부에서 접근 불가능
		 * 
		 * input = scanner.nextInt(); } catch (Exception e) { //e.printStackTrace();
		 * System.out.println("숫자로 좀 입력하시죠?"); scanner.nextLine(); input =
		 * scanner.nextInt(); }
		 */
